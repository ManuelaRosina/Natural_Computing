...
class ParticleSwarmOptimizedClustering:
    ...
    def predict(self, data: np.ndarray, best_centroid):
        ...
        """
        distance = self._calc_distance(data, best_centroid)
        # print(distance.shape)
        cluster = self._assign_cluster(distance)
        # print(cluster.shape)
        return cluster

    def _calc_distance(self, data: np.ndarray, best_centroid):
